...
export const Dashboard = props => {
  ...
  console.log('user confirm dashboard', user);
 
  const userConfirm = useSelector(getUserConfirm);
  console.log('userconfirm dashboard', userConfirm);
// console.log("user is",user.response.data.name)
  const logoutUser = () => {
    dispatch(logout());
  };
